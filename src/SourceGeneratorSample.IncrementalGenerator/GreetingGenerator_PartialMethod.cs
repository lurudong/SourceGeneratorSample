...
public sealed class GreetingGenerator_PartialMethod : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        //    Debugger.Launch();
        //}
        context.RegisterSourceOutput(context.SyntaxProvider.CreateSyntaxProvider(Condition,
            static (gsc, _) =>
            {
...
";
    ...
    private static bool Condition(SyntaxNode node, CancellationToken _)
    {
        ...
        //不包含Partial 关键字
        if (!methodModifiers.Any(SyntaxKind.PartialKeyword) || !typeModifiers.Any(SyntaxKind.PartialKeyword))
        {
            return false;
        }
